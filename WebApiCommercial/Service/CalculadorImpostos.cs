    ...
    public class CalculadorImpostos
    {
        ...
        public static Csticms ObterCSTICMS(string? cst)
        {
            ...
            if (int.TryParse(cst, out int valor))
            {
                return valor switch
                {
                    00 => Csticms.Cst00, 02 => Csticms.Cst02, 10 => Csticms.Cst10,
                    15 => Csticms.Cst15, 20 => Csticms.Cst20, 30 => Csticms.Cst30,
                    40 => Csticms.Cst40, 41 => Csticms.Cst41, 50 => Csticms.Cst50,
                    51 => Csticms.Cst51, 53 => Csticms.Cst53, 60 => Csticms.Cst60,
                    61 => Csticms.Cst61, 70 => Csticms.Cst70, 90 => Csticms.Cst90,
                    _ => Csticms.Cst00
                };
            }
        ...
        public static Csosnicms ObterCSOSN(string? csosn)
        {
            ...
            if (int.TryParse(csosn, out int valor))
            {
                return valor switch
                {
                    101 => Csosnicms.Csosn101, 102 => Csosnicms.Csosn102, 103 => Csosnicms.Csosn103,
                    201 => Csosnicms.Csosn201, 202 => Csosnicms.Csosn202, 203 => Csosnicms.Csosn203,
                    300 => Csosnicms.Csosn300, 400 => Csosnicms.Csosn400, 500 => Csosnicms.Csosn500,
        ...
        public static CSTPIS ObterCSTPIS(string? cst)
        {
            ...
            if (int.TryParse(cst, out int valor))
            {
                return valor switch
                {
                    01 => CSTPIS.pis01, 02 => CSTPIS.pis02, 03 => CSTPIS.pis03,
                    04 => CSTPIS.pis04, 05 => CSTPIS.pis05, 06 => CSTPIS.pis06,
                    07 => CSTPIS.pis07, 08 => CSTPIS.pis08, 09 => CSTPIS.pis09,
                    49 => CSTPIS.pis49, 50 => CSTPIS.pis50, 51 => CSTPIS.pis51,
                    52 => CSTPIS.pis52, 53 => CSTPIS.pis53, 54 => CSTPIS.pis54,
                    55 => CSTPIS.pis55, 56 => CSTPIS.pis56, 60 => CSTPIS.pis60,
                    61 => CSTPIS.pis61, 62 => CSTPIS.pis62, 63 => CSTPIS.pis63,
                    64 => CSTPIS.pis64, 65 => CSTPIS.pis65, 66 => CSTPIS.pis66,
                    67 => CSTPIS.pis67, 70 => CSTPIS.pis70, 71 => CSTPIS.pis71,
                    72 => CSTPIS.pis72, 73 => CSTPIS.pis73, 74 => CSTPIS.pis74,
                    75 => CSTPIS.pis75, 98 => CSTPIS.pis98, 99 => CSTPIS.pis99,
                    _ => CSTPIS.pis99
                };
            }
        ...
        public static CSTCOFINS ObterCSTCOFINS(string? cst)
        {
            ...
            if (int.TryParse(cst, out int valor))
            {
                return valor switch
                {
                    01 => CSTCOFINS.cofins01, 02 => CSTCOFINS.cofins02, 03 => CSTCOFINS.cofins03,
                    04 => CSTCOFINS.cofins04, 05 => CSTCOFINS.cofins05, 06 => CSTCOFINS.cofins06,
                    07 => CSTCOFINS.cofins07, 08 => CSTCOFINS.cofins08, 09 => CSTCOFINS.cofins09,
                    49 => CSTCOFINS.cofins49, 50 => CSTCOFINS.cofins50, 51 => CSTCOFINS.cofins51,
                    52 => CSTCOFINS.cofins52, 53 => CSTCOFINS.cofins53, 54 => CSTCOFINS.cofins54,
                    55 => CSTCOFINS.cofins55, 56 => CSTCOFINS.cofins56, 60 => CSTCOFINS.cofins60,
                    61 => CSTCOFINS.cofins61, 62 => CSTCOFINS.cofins62, 63 => CSTCOFINS.cofins63,
                    64 => CSTCOFINS.cofins64, 65 => CSTCOFINS.cofins65, 66 => CSTCOFINS.cofins66,
                    67 => CSTCOFINS.cofins67, 70 => CSTCOFINS.cofins70, 71 => CSTCOFINS.cofins71,
                    72 => CSTCOFINS.cofins72, 73 => CSTCOFINS.cofins73, 74 => CSTCOFINS.cofins74,
                    75 => CSTCOFINS.cofins75, 98 => CSTCOFINS.cofins98, 99 => CSTCOFINS.cofins99,
        ...
        public static CSTIPI ObterCSTIPI(string? cst)
        {
            ...
            if (int.TryParse(cst, out int valor))
            {
                return valor switch
                {
                    00 => CSTIPI.ipi00, 01 => CSTIPI.ipi01, 02 => CSTIPI.ipi02,
                    03 => CSTIPI.ipi03, 04 => CSTIPI.ipi04, 05 => CSTIPI.ipi05,
                    49 => CSTIPI.ipi49, 50 => CSTIPI.ipi50, 51 => CSTIPI.ipi51,
                    52 => CSTIPI.ipi52, 53 => CSTIPI.ipi53, 54 => CSTIPI.ipi54,
                    55 => CSTIPI.ipi55, 99 => CSTIPI.ipi99,
                    _ => CSTIPI.ipi50
                };
            }
